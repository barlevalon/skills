...
When exploring the codebase, read `CONTEXT.md` if present so test names and interface vocabulary match the project's domain language, and respect ADRs in the area you're touching.
...
- If you wrote it in this session as implementation or exploration, discard it and restart from RED. Do not keep it as reference by default.
- Do not delete pre-existing or user-authored work without permission.
